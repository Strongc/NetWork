...
void WebServerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        WebServerThread *_t = static_cast<WebServerThread *>(_o);
        switch (_id) {
        case 0: _t->sig_returnMessagae((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData WebServerThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WebServerThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_WebServerThread,
      qt_meta_data_WebServerThread, &staticMetaObjectExtraData }
};
